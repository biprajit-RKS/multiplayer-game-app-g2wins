    ...
    .defines(function () {
        GameClient = ig.Class.extend({
            ...
            onPlayerLeft: function (data) {
                ...
                console.log('Remaining players: ' + data.gameState.length);
                ...
                if (data.gameState.length > 1) {
                    ...
                    console.log('🏆 Only 1 player remaining - You win by default!');
                    if (!ig.game.botMode && ig.game.gameInitData && typeof sendScore === 'function') {
                        sendScore(1);
                    }
